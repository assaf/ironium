...
module.exports = class Configuration {
  ...
  constructor(config) {
    ...
    if (config.project_id || config.token) {
      ...
      this.authenticate     = Util.format(IRONIO_AUTHENTICATE, config.token, config.project_id);
      ...
      // Beanstalkd
      this.hostname         = config.host || BEANSTALKD_HOSTNAME;
